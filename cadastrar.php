...
<html lang="pt-br">
	...
	<body>
		<div class="container">
			<div class="form-signin" style="background: #74C8D5; padding-top: 20px; padding-bottom: 20px;">
				...
				<form method="POST" action="">
					<!--<label>Nome</label>-->
					<input type="text" name="nome" placeholder="Digite o nome e o sobrenome" class="form-control" style="width: 326px; margin: 0 auto" ><br>
					
					<!--<label>E-mail</label>-->
					<input type="text" name="email" placeholder="Digite o seu e-mail" class="form-control"  style="width: 326px; margin: 0 auto"><br>
					
					<!--<label>Usuário</label>-->
					<input type="text" name="usuario" placeholder="Digite o usuário" class="form-control"  style="width: 326px; margin: 0 auto"><br>
					
					<!--<label>Senha</label>-->
					<input type="password" name="senha" placeholder="Digite a senha" class="form-control"  style="width: 326px; margin: 0 auto"><br>
					
					<input type="submit" name="btnCadUsuario" value="Cadastrar" class="btn btn-success"  style="width: 326px; margin-left: 407px"><br><br>
